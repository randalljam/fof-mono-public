...
USERS_HMAC_SECRET_KEY = os.environ["USERS_HMAC_SECRET_KEY"]
...
# ===== API GATEWAY SECTION OF FILE core/aws.py =====
...
def log_deployment_to_history(api_gateway_name, stage, deployment_type="API Gateway deployment", detailed_log_path=None):
    ...
    try:
        ...
        log_file = os.path.join(log_dir, "web-shared/aws_chalice/chalicelib_mirror_deploy_log.md")

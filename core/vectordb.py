# ===== START OF FILE core/vectordb.py =====
...
def generate_vectors_qa(folder_paths, suffixpat_include, include_subfolders=False, embedding_field='QUESTION', date_from_filename=False, dummy_run=False):
    ...
    """
    from core.fileops import get_files_in_folder, get_timestamp
    from core.structured import get_blocks_from_file, get_all_fields_dict, validate_iso_dates_in_filename, validate_blocks_in_folders
...
def setup_create_vectordb(folder_paths, vector_index_base, suffixpat_include=None):
    ...
    """
    from core.fileops import get_files_in_folder, get_current_datetime_filefriendly
    import inspect
...
def create_vectordb_vrag_langchain(folder_paths, vector_index_base, suffixpat_include=None, skip_pinecone=False):  # pinecone index names can only contain - and not _ 
    ...
    :return: None
    """ 
    from core.fileops import apply_to_folder, create_new_file_from_heading, sub_suffix_in_file, move_files_with_suffix, remove_timestamp_links, find_and_replace_pairs

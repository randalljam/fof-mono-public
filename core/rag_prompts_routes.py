# ===== START OF FILE core/rag_prompts_routes.py =====
...
ROUTES_DICT_SOVEREIGN_CHILD_M1 = {
    ...
    'route_preamble_good_match': (
        "There is a GOOD MATCH in our extracted quotes. Below is the official source Q&A. The AI ANSWER above synthesizes these direct quotes along with the book text from 'The Sovereign Child' and your specific question.\n"
    ),
    ...
    'route_preamble_partial_match': (
        "There is a PARTIAL MATCH in our extracted quotes. Below is the official source Q&A. The AI ANSWER above synthesizes these direct quotes along with the book text from 'The Sovereign Child' and your specific question.\n"
    ),
    ...
    'route_preamble_no_match': (
        ...
        "The AI ANSWER above uses the book text from 'The Sovereign Child' as well as the model's background knowledge of the philosophy of Taking Children Seriously and the ideas of David Deutsch.\n"
    ),
...
ROUTES_DICT_FDA_TOWNHALLS_M1 = {
    ...
    'route_preamble_good_match': (
        "There is a GOOD MATCH in our extracted quotes. Below is the official FDA Q&A. The AI ANSWER above synthesizes these official sources with your specific question.\n"
    ),
    ...
    'route_preamble_partial_match': (
        "There is a PARTIAL MATCH in our extracted quotes. Below is the official FDA Q&A. The AI ANSWER above synthesizes these official sources with your specific question.\n"
    ),
...
ROUTES_DICT_PV_EVAC_M1 = {
    ...
    'route_preamble_good_match': (
        "There is a GOOD MATCH in our extracted quotes. Below is the official source Q&A. The AI ANSWER above synthesizes these official sources with current evacuation protocols and your specific question.\n"
    ),
    ...
    'route_preamble_partial_match': (
        "There is a PARTIAL MATCH in our extracted quotes. Below is the official source Q&A. The AI ANSWER above synthesizes these official sources with current evacuation protocols and your specific question.\n"
    ),
...
ROUTES_DICT_DEUTSCH_M1 = {
    ...
    'route_preamble_good_match': (
        "There is a GOOD MATCH in our extracted quotes. Below is the official source Q&A. The AI ANSWER above synthesizes these direct quotes along with a summary of David Deutsch's philosophy and your specific question.\n"
    ),
    ...
    'route_preamble_partial_match': (
        "There is a PARTIAL MATCH in our extracted quotes. Below is the official source Q&A. The AI ANSWER above synthesizes these direct quotes along with a summary of David Deutsch's philosophy and your specific question.\n"
    ),
    ...
    'route_preamble_no_match': (
        "There is NO MATCH in the extracted quotes.\n"
        "The AI ANSWER above uses a summary of David Deutsch's philosophy of deep optimism along with the model's background knowledge of David Deutsch's philosophy and ideas."
    ),
...
# ===== END OF FILE core/rag_prompts_routes.py =====
